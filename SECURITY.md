...
Do not commit private RPC endpoints, wallet keys, mnemonics, private keys, production configuration, or paid-provider API keys. Keep generated `neozork-config` and scan output local unless they are explicitly sanitized.
